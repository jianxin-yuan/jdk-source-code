...
public abstract class UNIXToolkit extends SunToolkit {
    ...
    public static int getDatatransferTimeout() {
        Integer var0 = (Integer)AccessController.doPrivileged(new GetIntegerAction("sun.awt.datatransfer.timeout"));
    ...
    protected Object lazilyLoadGTKIcon(String var1) {
        ...
        if (var2 != null) {
            ...
            if (var3.length != 5) {
                ...
                TextDirection var5 = "ltr".equals(var3[4]) ? TextDirection.LTR : TextDirection.RTL;
